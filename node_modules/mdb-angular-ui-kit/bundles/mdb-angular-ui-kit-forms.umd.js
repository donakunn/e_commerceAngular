(function (global, factory) {
    ...
    var MdbInputDirective = /** @class */ (function () {
        ...
        MdbInputDirective.prototype._updateTextColorForDateType = function () {
            var actualColor = getComputedStyle(this._elementRef.nativeElement).color;
            this._color = actualColor !== 'rgba(0, 0, 0, 0)' ? actualColor : this._color;
            var color = this.labelActive ? this._color : "transparent";
